...
class HistoryGameViewController: GameViewController {
    ...
    private func addTheBonusChoiceView() {
        ...
        bonusChoiceView = BonusChoiceView(frame: frame, viewOfGame: viewOfGame!, backgroundColor: Color.rgb(194, 194, 186), lineColor: UIColor(red: 0.5, green: 0.5, blue: 0.45, alpha: 1))
