...
class HistoryGameViewController: GameViewController {
    ...
    private func addTheBonusChoiceView() {
        ...
        bonusChoiceView = BonusChoiceView(frame: frame, viewOfGame: viewOfGame!, backgroundColor: colorForRGB(r: 194, g: 194, b: 186), lineColor: UIColor(red: 0.5, green: 0.5, blue: 0.45, alpha: 1))
