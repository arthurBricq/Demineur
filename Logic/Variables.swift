...
class Section {
    ...
    convenience init(simpleSquareGameWith dimensions: (n: Int,m: Int) ) {
        ...
        let secondGame = OneGame(gameTypeWithNoneCases: .square, n: dimensions.n, m: dimensions.m, z: 2, numberOfFlag: 4, isTimerAllowed: true, totalTime: 60, option1: false, option2: false, option1Time: 0, option2Frequency: 0, option3: false, option3Frequency: 0.5, option3Time: 2, noneCases: [], areNumbersShowed: true)
