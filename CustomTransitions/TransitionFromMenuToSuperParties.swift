//
//  TransitionFromMenuToSuperParties.swift
//  Demineur
//
//  Created by Arthur BRICQ on 25/06/2019.
...
class TransitionFromMenuToSuperParties: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let toVC = transitionContext.viewController(forKey: .to) as! SuperPartiesPresentationViewController
        ...
        let x1 = fromVC.getInitialXPositionForTransitionToSuperParties()
        let y1 = fromVC.getInitialYPositionForTransitionToSuperParties()
        let y2 = toVC.getYPositionForTransition()
//        let x3 = toVC.getLastXPositionForTransition()
        let w = fromView.frame.width
        let multiplier: CGFloat = 0.94
