...
class TransitionToReglage: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if presenting {
            ...
            let toVC = transitionContext.viewController(forKey: .to) as! ReglageViewController
            ...
            let fromVC = transitionContext.viewController(forKey: .from) as! ReglageViewController
