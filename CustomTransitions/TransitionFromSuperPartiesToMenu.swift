//
//  TransitionFromSuperPartiesToMenu.swift
//  Demineur
//
//  Created by Arthur BRICQ on 26/06/2019.
...
class TransitionFromSuperPartiesToMenu: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        let fromVC = transitionContext.viewController(forKey: .from) as! SuperPartiesPresentationViewController
