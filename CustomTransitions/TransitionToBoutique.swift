...
class TransitionToBoutique: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if presenting {
            ...
            let toVC = transitionContext.viewController(forKey: .to) as! BoutiqueViewController
            ...
            let fromVC = transitionContext.viewController(forKey: .from) as! BoutiqueViewController
