...
class TransitionToWinLose: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        if presenting {
            ...
            let fromVC = transitionContext.viewController(forKey: .from) as! WinLooseViewController
            let toVC = transitionContext.viewController(forKey: .to) as! HistoryGameViewController
