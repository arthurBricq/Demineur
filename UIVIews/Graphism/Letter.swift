...
class Letter: UIView {
    ...
    override func draw(_ rect: CGRect) {
        ...
        if letter == "M" {
            ...
            D.drawCanvas1(frame: rect, resizing: .aspectFill, width: width, color: color)
        }
        else {
            return
        }
...
public class D : NSObject {
    ...
    @objc dynamic public class func drawCanvas1(frame targetFrame: CGRect = CGRect(x: 0, y: 0, width: 120, height: 120), resizing: ResizingBehavior = .aspectFit, width: CGFloat = 2, color: UIColor) {
        //// General Declarations
        let context = UIGraphicsGetCurrentContext()!
        ...
        //// Bezier Drawing
        let bezierPath = UIBezierPath()
        bezierPath.move(to: CGPoint(x: 7, y: 120))
        ...
        //// Bezier 2 Drawing
        let bezier2Path = UIBezierPath()
        bezier2Path.move(to: CGPoint(x: 33, y: 1))
        bezier2Path.addCurve(to: CGPoint(x: 100, y: 59.04), controlPoint1: CGPoint(x: 33, y: 1), controlPoint2: CGPoint(x: 100, y: -0.44))
        bezier2Path.addCurve(to: CGPoint(x: 33, y: 119), controlPoint1: CGPoint(x: 100, y: 118.52), controlPoint2: CGPoint(x: 33, y: 119))
        color.setStroke()
        bezier2Path.lineWidth = width
        bezier2Path.stroke()
